...
ubi_$(FLASH_TYPE)_config_script:
	...
	@echo setenv bootargsspi  $(rootfs$(BOOTENV)) $(kernel$(BOOTENV)) $(EXBOOTARGS) \$$\(mtdparts\) >> $(SCRIPTDIR)/set_config
	@cat /dvlp/Projects/tzpu/FusionX/software/linux/project/bootargs.txt >> $(SCRIPTDIR)/set_config
ifeq ($(PROJECT), BACKUP2D06)
...
ifeq ($(PROJECT), 2D07)
	...
	@echo setenv bootcmd \' bootlogo 0 0 0 0 0\; nand read.e $(KERNELBOOTADDR) KERNEL $(kernel$(PATSIZE))\; bootm $(KERNELBOOTADDR)\;nand read.e $(KERNELBOOTADDR) RECOVERY $(kernel$(PATSIZE))\; bootm $(KERNELBOOTADDR) >> $(SCRIPTDIR)/set_config
endif
